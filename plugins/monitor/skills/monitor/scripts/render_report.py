...
{kpis}  </div>"""
  ...
  <section class="rsection">
    <h2>Next Steps</h2>
    <ol class="steps">
      <!-- One <li> per actionable next step in the PROJECT/CODE, e.g. "add
           retry handling to X", "migrate Y to Z". Never a description of
           this authoring session's own turn (asking the user something,
           awaiting approval, "present options") -- that belongs in the chat
           reply, not the report. If there is truly no next step, omit the
           section rather than filling it with a meta-statement. -->
    </ol>
  </section>"""
