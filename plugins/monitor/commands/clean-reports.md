---
description: Delete the oldest N reports and re-render the Reports index + Dashboard.
---

Delete the oldest **$ARGUMENTS** reports via the monitor engine.
...
3. On confirmation, run without `--dry-run`:
   ...
   (deletes the oldest N report files and re-renders the Reports index +
