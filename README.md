...
- **Logs** (`monitor/logs/`) — a canonical, newest-first `operations.log` (schema locked in code, not profile-driven), rendered to paginated, filterable HTML. Never hand-edited — always written through `logger.py`.
