...
- **Logs** (`monitor/logs/`) — a canonical, newest-first `operations.log` (schema locked in code), rendered to paginated, filterable HTML. Never hand-edited — always written through `logger.py`.
